...
pub(crate) fn expect_ident<I>(it: &mut I, expect_msg:  &str) -> String 
    where I: Iterator<Item = proc_macro2::TokenTree>
{
...
pub(crate) fn expect_group<I>(it: &mut I, delimiter: proc_macro2::Delimiter, expect_msg: &str) -> proc_macro2::TokenStream 
    where I: Iterator<Item = proc_macro2::TokenTree>
{
    use proc_macro2::TokenTree::*;
...
pub(crate) fn skip_until_punct(it: &mut Peekable<IntoIter>, punct: char) -> Peekable<IntoIter> {
    ...
    proc_macro2::TokenStream::from_iter(new_it).into_iter().peekable()
}
